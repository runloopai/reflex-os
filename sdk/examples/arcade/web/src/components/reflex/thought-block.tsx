...
export function ThoughtBlock({
  ...
  return (
    <details className="group mx-1" open={defaultOpen}>
      ...
      <div className="mt-1 border-l-2 border-[var(--reflex-chat-border,#e5e7eb)] py-0.5 pl-2.5 text-xs [overflow-wrap:anywhere] break-words whitespace-pre-wrap text-[var(--reflex-chat-muted-fg,#6b7280)] italic opacity-70">
        {children}
      </div>
    </details>
  );
