// AUTO-SYNCED from sdk/chat-kit/registry/components/message-list.tsx — edit there, then run `pnpm --filter @runloop/reflex-ui sync`.
/**
...
import { buildAgentTimeline, groupToolRuns } from '../lib/event-utils';
    ...
    <div className="relative min-h-0 flex-1">
      ...
      {showJump ? (
        <button
          ...
          className="absolute bottom-3 left-1/2 flex h-8 w-8 -translate-x-1/2 items-center justify-center rounded-full border border-[var(--reflex-chat-border,#e5e7eb)] bg-[var(--reflex-chat-bg,#ffffff)] text-[var(--reflex-chat-fg,#111827)] shadow-md transition hover:brightness-110"
        >
