// AUTO-SYNCED from sdk/chat-kit/registry/components/message-bubble.tsx — edit there, then run `pnpm --filter @runloop/reflex-ui sync`.
/**
 ...
 */
import type { ChatMessage } from '../lib/event-utils';
