// AUTO-SYNCED from sdk/chat-kit/registry/components/tool-call-line.tsx — edit there, then run `pnpm --filter @runloop/reflex-ui sync`.
/**
...
import type { AgentTimelineItem } from '../lib/event-utils';
