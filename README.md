...
- [`sdk/client`](sdk/client) is the API client. Its `src/generated/` directory is produced from Reflex's public OpenAPI document, so it never drifts from the running API.
